...
private:
  std::vector<unsigned char> createZipInMemory(const std::string &content,
    ...
    int32_t written = mz_zip_entry_write(zip_handle, content.data(),
